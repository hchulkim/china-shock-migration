...
kor_from_chn_import_2010_2001 <-  haven::read_dta("data/final/hs_cpc_ksic/kor_import2010_2001_drop26.dta")
kor_from_chn_import_2019_2010 <-  haven::read_dta("data/final/hs_cpc_ksic/kor_import2019_2010_drop26.dta")
kor_from_chn_import_2019_2001 <-  haven::read_dta("data/final/hs_cpc_ksic/kor_import2019_2001_drop26.dta")
kor_to_chn_export_2010_2001 <-   haven::read_dta("data/final/hs_cpc_ksic/kor_export2010_2001_drop26.dta")
kor_to_chn_export_2019_2010 <-   haven::read_dta("data/final/hs_cpc_ksic/kor_export2019_2010_drop26.dta")
kor_to_chn_export_2019_2001 <-   haven::read_dta("data/final/hs_cpc_ksic/kor_export2019_2001_drop26.dta")
...
imp2010 %>% write_rds("data/final/shock/imp2010_cz_drop26.rds")
imp2019 %>% write_rds("data/final/shock/imp2019_cz_drop26.rds")
exp2010 %>% write_rds("data/final/shock/exp2010_cz_drop26.rds")
exp2019 %>% write_rds("data/final/shock/exp2019_cz_drop26.rds")

imp %>% write_rds("data/final/shock/imp_cz_drop26.rds")
exp %>% write_rds("data/final/shock/exp_cz_drop26.rds")
