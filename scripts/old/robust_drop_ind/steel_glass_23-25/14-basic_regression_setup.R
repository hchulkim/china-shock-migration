...
imp2010 <- read_rds("data/final/shock/imp2010_cz_drop2325.rds")
imp2019 <- read_rds("data/final/shock/imp2019_cz_drop2325.rds")
exp2010 <- read_rds("data/final/shock/exp2010_cz_drop2325.rds")
exp2019 <- read_rds("data/final/shock/exp2019_cz_drop2325.rds")
...
imp1999_1_iv <-read_rds("data/final/shock/imp1999_1_iv_cz_drop2325.rds")
exp1999_1_iv <-read_rds("data/final/shock/exp1999_1_iv_cz_drop2325.rds")

imp1999_2_iv <-read_rds("data/final/shock/imp1999_2_iv_cz_drop2325.rds")
exp1999_2_iv <-read_rds("data/final/shock/exp1999_2_iv_cz_drop2325.rds")
...
migration %>% write_rds("data/final/shock/shock_main_data_sigungu_two_period_drop2325.rds")
...
#save it
imp0 %>% write_rds("data/final/shock/shock_main_data2001_2019_drop2325.rds")
