...
jpn_from_chn_import2001 <- jpn_from_chn_import2001 %>%
  filter(as.numeric(str_sub(ksic10, 1, 3))!=263)

jpn_from_chn_import2010 <- jpn_from_chn_import2010 %>%
  filter(as.numeric(str_sub(ksic10, 1, 3))!=263)

jpn_from_chn_import2019 <- jpn_from_chn_import2019 %>%
  filter(as.numeric(str_sub(ksic10, 1, 3))!=263)

jpn_to_chn_export2001 <- jpn_to_chn_export2001 %>%
  filter(as.numeric(str_sub(ksic10, 1, 3))!=263)

jpn_to_chn_export2010 <- jpn_to_chn_export2010 %>%
  filter(as.numeric(str_sub(ksic10, 1, 3))!=263)

jpn_to_chn_export2019 <- jpn_to_chn_export2019 %>%
  filter(as.numeric(str_sub(ksic10, 1, 3))!=263)
...
jpn_from_chn_import_2010_2001 %>%  haven::write_dta("data/final/hs_cpc_ksic/jpn_import2010_2001_drop26.dta")
jpn_from_chn_import_2019_2010 %>%  haven::write_dta("data/final/hs_cpc_ksic/jpn_import2019_2010_drop26.dta")
jpn_from_chn_import_2019_2001 %>%  haven::write_dta("data/final/hs_cpc_ksic/jpn_import2019_2001_drop26.dta")
jpn_to_chn_export_2010_2001 %>%  haven::write_dta("data/final/hs_cpc_ksic/jpn_export2010_2001_drop26.dta")
jpn_to_chn_export_2019_2010 %>%  haven::write_dta("data/final/hs_cpc_ksic/jpn_export2019_2010_drop26.dta")
jpn_to_chn_export_2019_2001 %>%  haven::write_dta("data/final/hs_cpc_ksic/jpn_export2019_2001_drop26.dta")
