...
imp <- read_rds("data/final/shock/imp_cz_drop1315.rds")
exp <- read_rds("data/final/shock/exp_cz_drop1315.rds")

imp1999_iv <-read_rds("data/final/shock/imp1999_iv_cz_drop1315.rds")
exp1999_iv <-read_rds("data/final/shock/exp1999_iv_cz_drop1315.rds")
...
imp2010 <- read_rds("data/final/shock/imp2010_cz_drop1315.rds") %>% mutate(year=1)
imp2019 <- read_rds("data/final/shock/imp2019_cz_drop1315.rds") %>% mutate(year=2)
exp2010 <- read_rds("data/final/shock/exp2010_cz_drop1315.rds") %>% mutate(year=1)
exp2019 <- read_rds("data/final/shock/exp2019_cz_drop1315.rds") %>% mutate(year=2)

imp1999_1_iv <-read_rds("data/final/shock/imp1999_1_iv_cz_drop1315.rds") %>% mutate(year=1)
exp1999_1_iv <-read_rds("data/final/shock/exp1999_1_iv_cz_drop1315.rds") %>% mutate(year=1)

imp1999_2_iv <-read_rds("data/final/shock/imp1999_2_iv_cz_drop1315.rds") %>% mutate(year=2)
exp1999_2_iv <-read_rds("data/final/shock/exp1999_2_iv_cz_drop1315.rds") %>% mutate(year=2)
