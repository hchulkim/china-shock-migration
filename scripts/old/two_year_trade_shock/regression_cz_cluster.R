...
out_dest <- feols(log(migrate) ~ log(pop2001_d) + log(pop2001_o) | 
                    shock  ~ shock_iv, 
                  weights = tb_all$pop2001_o, cluster=tb_all$cz_o, data=tb_all %>% 
...
texreg(list(out_dest, out_org, out_all), stars=c(0.1, 0.05, 0.01, 0.001), digits=5, booktabs = TRUE,
       include.adjrs = FALSE, include.proj.stats=FALSE, use.packages = FALSE, table=FALSE, custom.model.names = c("dest", "origin", "both"), custom.coef.map = list("fit_shock"="fit_shock", "fit_shock_o"="fit_shock_o", "fit_shock_d"="fit_shock_d", "log(pop2001_o)"="log(pop2001_o)", "log(pop2001_d)"="log(pop2001_d)", "(Intercept)"="Intercept"), file="results/tables/out_all_nocontrol_world_sigungucluster.tex")
...
texreg(list(out_dest, out_org, out_all), stars=c(0.1, 0.05, 0.01, 0.001), digits=5, booktabs = TRUE,
       include.adjrs = FALSE, include.proj.stats=FALSE, use.packages = FALSE, table=FALSE, custom.model.names = c("dest", "origin", "both"), custom.coef.map = list("fit_imp_shock_d"="fit_imp_shock_d", "fit_exp_shock_d"="fit_exp_shock_d", "fit_imp_shock_o"="fit_imp_shock_o", "fit_exp_shock_o"="fit_exp_shock_o", "log(pop2001_o)"="log(pop2001_o)", "log(pop2001_d)"="log(pop2001_d)", "(Intercept)"="Intercept"), file="results/tables/out_all_nocontrol_world_sep_sigungucluster.tex")
...
texreg(list(out_dest, out_org, out_all), stars=c(0.1, 0.05, 0.01, 0.001), digits=5, booktabs = TRUE,
       include.adjrs = FALSE, include.proj.stats=FALSE, use.packages = FALSE, table=FALSE,  custom.model.names = c("dest", "origin", "both"), custom.coef.map = list("fit_shock"="fit_shock", "fit_shock_o"="fit_shock_o", "fit_shock_d"="fit_shock_d", "log(pop2001_o)"="log(pop2001_o)", "log(pop2001_d)"="log(pop2001_d)", "log(distance)"="log(distance)", "emp_share_female_o"="emp_share_female_o", "emp_share_female_d"="emp_share_female_d", "emp_share_manu_o"="emp_share_manu_o", "emp_share_manu_d"="emp_share_manu_d", "edu_o"="edu_o", "edu_d"="edu_d", "(Intercept)"="Intercept"), file="results/tables/out_all_control_sigungucluster.tex")
...
texreg(list(out_dest, out_org, out_all), stars=c(0.1, 0.05, 0.01, 0.001), digits=5, booktabs = TRUE,
       include.adjrs = FALSE, include.proj.stats=FALSE, use.packages = FALSE, table=FALSE, custom.model.names = c("dest", "origin", "both"), custom.coef.map = list("fit_imp_shock_d"="fit_imp_shock_d", "fit_exp_shock_d"="fit_exp_shock_d", "fit_imp_shock_o"="fit_imp_shock_o", "fit_exp_shock_o"="fit_exp_shock_o", "log(pop2001_o)"="log(pop2001_o)", "log(pop2001_d)"="log(pop2001_d)", "log(distance)"="log(distance)", "emp_share_female_o"="emp_share_female_o", "emp_share_female_d"="emp_share_female_d", "emp_share_manu_o"="emp_share_manu_o", "emp_share_manu_d"="emp_share_manu_d", "edu_o"="edu_o", "edu_d"="edu_d", "(Intercept)"="Intercept"), file="results/tables/out_all_control_sep_sigungucluster.tex")
...
texreg(list(out_dest, out_org, out_all), stars=c(0.1, 0.05, 0.01, 0.001), digits=5, booktabs = TRUE,
       include.adjrs = FALSE, include.proj.stats=FALSE, use.packages = FALSE, table=FALSE, custom.model.names = c("dest", "origin", "both"), custom.coef.map = list("fit_shock"="fit_shock", "fit_shock_o"="fit_shock_o", "fit_shock_d"="fit_shock_d", "log(pop2001_o)"="log(pop2001_o)", "log(pop2001_d)"="log(pop2001_d)", "log(distance)"="log(distance)", "emp_share_female_o"="emp_share_female_o", "emp_share_female_d"="emp_share_female_d", "emp_share_manu_o"="emp_share_manu_o", "emp_share_manu_d"="emp_share_manu_d", "edu_o"="edu_o", "edu_d"="edu_d", "(Intercept)"="Intercept"), file="results/tables/out_all_control_world_sigungucluster.tex")
...
texreg(list(out_dest, out_org, out_all), stars=c(0.1, 0.05, 0.01, 0.001), digits=5, booktabs = TRUE,
       include.adjrs = FALSE, include.proj.stats=FALSE, use.packages = FALSE, table=FALSE, custom.model.names = c("dest", "origin", "both"), custom.coef.map = list("fit_imp_shock_d"="fit_imp_shock_d", "fit_exp_shock_d"="fit_exp_shock_d", "fit_imp_shock_o"="fit_imp_shock_o", "fit_exp_shock_o"="fit_exp_shock_o", "log(pop2001_o)"="log(pop2001_o)", "log(pop2001_d)"="log(pop2001_d)", "log(distance)"="log(distance)", "emp_share_female_o"="emp_share_female_o", "emp_share_female_d"="emp_share_female_d", "emp_share_manu_o"="emp_share_manu_o", "emp_share_manu_d"="emp_share_manu_d", "edu_o"="edu_o", "edu_d"="edu_d", "(Intercept)"="Intercept"), file="results/tables/out_all_control_world_sep_sigungucluster.tex")
