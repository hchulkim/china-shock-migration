...
est1994 <- read.table("data/est/est1994.csv", header=FALSE, sep=",", colClasses = c("character"
...
est1996 <- read.table("data/est/est1996.csv", header=FALSE, sep=",", colClasses = c("character"
                                                                                    , "character", "character", "character", "character", "character", "character", "numeric"), na.string=c("*","**","***","****","*****","******","*******","********","*********","**********","."))
...
est1999 <- read.table("data/est/est1999.csv", header=FALSE, sep=",", colClasses = c("character"
                                                                                    , "character", "character", "character", "character", "character", "character", "numeric"), na.string=c("*","**","***","****","*****","******","*******","********","*********","**********","."))
...
est2001 <- read.table("data/est/est2001.csv", header=FALSE, sep=",", colClasses = c("character"
...
est2019 <- read.table("data/est/est2019.csv", header=FALSE, sep=",", colClasses = c("character"
...
est1994 %>% write_rds("data/est/est1994.rds")
est1996 %>% write_rds("data/est/est1996.rds")
# est1998 %>% write_rds("data/est/est1998.rds")
est1999 %>% write_rds("data/est/est1999.rds")
est2000 %>% write_rds("data/est/est2000.rds")

est2001 %>% write_rds("data/est/est2001.rds")
est2010 %>% write_rds("data/est/est2010.rds")
est2019 %>% write_rds("data/est/est2019.rds")
