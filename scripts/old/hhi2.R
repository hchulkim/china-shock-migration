...
out_sep1 <- feols(log(migrate) ~ log(pop2001_d) + log(pop2001_o) + log(distance) + emp_share_female_o + emp_share_female_d + emp_share_manu_o + emp_share_manu_d + edu_o + edu_d | 
                    imp_shock_o + imp_shock_o:hhi_index_o + exp_shock_o + exp_shock_o:hhi_index_o + imp_shock_d + exp_shock_d  ~ imp_shock1999_iv_o + imp_shock1999_iv_o:hhi_index_o + exp_shock1999_iv_o + exp_shock1999_iv_o:hhi_index_o + imp_shock1999_iv_d + exp_shock1999_iv_d, 
                  weights = tb_all$pop2001_o, cluster=tb_all$iso_o, data=tb_all)
