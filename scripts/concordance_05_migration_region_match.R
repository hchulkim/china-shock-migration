...
region_stat <- readxl::read_excel("data/concordance/region/region_stat.xlsx")

region_stat <- region_stat %>% mutate(across(everything(), as.character))

region_kosis <- readxl::read_excel("data/concordance/region/region_kosis.xlsx")
...
migration1996_2000 %>% write_rds("data/temp/migration1996_2000.rds")
...
migration2001_2014 %>% write_rds("data/temp/migration2001_2014.rds")
...
migration2015_2019 %>% write_rds("data/temp/migration2015_2019.rds")


migration1996_2000 <- read_rds("data/temp/migration1996_2000.rds")
...
migration1996_2000 <- read_rds("data/temp/migration1996_2000.rds")
migration2001_2014 <- read_rds("data/temp/migration2001_2014.rds")
migration2015_2019 <- read_rds("data/temp/migration2015_2019.rds")
...
migration1996_2000 %>% write_rds("data/temp/migration1996_2000_refine.rds")
migration2001_2014 %>% write_rds("data/temp/migration2001_2014_refine.rds")
migration2015_2019 %>% write_rds("data/temp/migration2015_2019_refine.rds")
...
migration2020 %>% write_rds("data/temp/migration2020_refine.rds")
