...
# Date: June 12, 2024
# Description: This file makes the concordance table for hs-hs, hs-cpc, cpc-cpc, cpc-ksic, ksic-ksic. Basically our main objective is to transition hs code to ksic code.
